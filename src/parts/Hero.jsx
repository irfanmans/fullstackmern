...
import IconCities from "../assets/images/icons/IconCity.svg";
        ...
        <>
            <section className="pt-14 md:grid md:grid-cols-2 md:gap-10 lg:flex lg:justify-between lg:items-center">
                <div className="lg:max-w-[550px]">
                    <h1 className="font-bold font-poppins text-2xl text-[#152c5b] leading-8">
                        Forget Busy Work, <br />
                        Start Next Vacation
                    </h1>
                    <p className="font-poppins text-xs mt-3 leading-5 text-[#5D5D5D]">We provide what you need to enjoy your holiday with family. Time to make another memorable moments. Your money can return, but your time is not</p>
                    <Button className="py-2 px-10 mt-4 rounded-md font-poppins" hasShadow isPrimary onClick={showMostPicked}>
                        Show Me
                    </Button>
                    <div className="grid grid-cols-3 gap-4 mt-10 lg:max-w-[340px]">
                        <div>
                ...
                <div className="mt-16 max-w-[450px] md:mt-0">
                    <img src={Banner} />
                </div>
            </section>
        </>
